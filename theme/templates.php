          ...
          <div class="col-sm-6">
            <div class="contactinfo">
              <ul class="nav nav-pills">
                ...
                <li><a href="#"><i class="fa fa-envelope"></i> softqaofficial@gmail.com</a></li>
              </ul>
            </div>
          </div>
          <div class="col-sm-6">
...
<?php 
    ...
    <div class="footer-bottom">
      <div class="container">
        <div class="row">
            <center>&copy Copyright 2020 Softqa, All Rights Reserved</center>
          <p class="pull-right">Designed by <span><a target="_blank" href="http://www.softqa.com">Softqa</a></span></p>
        </div>
      </div>
    </div>
  </footer>
